...
describe('FlowerDetailPanel', () => {
  it('shows the experiment details and author comment without a prompt section', () => {
    render(<FlowerDetailPanel flower={flower} figure={2} onClose={() => {}} />);
  ...
  it('shows the author as plain text when no github handle is given', () => {
    ...
    render(<FlowerDetailPanel flower={noGithub} figure={2} onClose={() => {}} />);
  ...
  it('calls onClose when the close button is clicked', async () => {
    const onClose = vi.fn();
    render(<FlowerDetailPanel flower={flower} figure={2} onClose={onClose} />);
